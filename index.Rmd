...
From confusion matrix it is very clear that our model is having good accuracy and not overfitted to training set. With this accuracy we can run this on testing set for predicting classe.
